...
$(document).ready(function() {
  ...
  $("#current-location").on("click", function() {
    // take the value of "currentcity"and save it in variable "searchValue"
    // searchValue = currentcity;
    // take the value of "search-value" id and clear the value
    $("#search-value").val(currentcity);
    // fire function "searchWeather" with searchValue as an argument
    // searchWeather(searchValue);
  });
  ...
  function searchWeather(searchValue) {
    ...
    $.ajax({
      ...
      url:
        ...
        searchValue +
        "&appid=600327cb1a9160fea2ab005509d1dc6d&units=imperial",
  ...
  function getUVIndex(lat, lon) {
    ...
    $.ajax({
      ...
      url:
        "https://api.openweathermap.org/data/2.5/uvi?appid=600327cb1a9160fea2ab005509d1dc6d&lat=" +
        lat +
        "&lon=" +
        lon,
      // selects dataType of JSON JavaScript Object Notation
  ...
  $.ajax({
    url: "http://ip-api.com/json/?fields=status,city",
    method: "GET"
